(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ui try projectile orderless consult marginalia vertico git-gutter evil rust-mode lsp-pyright flycheck company go-mode lsp-mode base16-theme undo-fu evil-collection)))
(custom-set-faces
