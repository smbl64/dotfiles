(custom-set-variables
 ...
 '(package-selected-packages
   '(try projectile orderless consult marginalia vertico git-gutter evil rust-mode lsp-pyright flycheck company lsp-ui go-mode lsp-mode base16-theme undo-fu evil-collection)))
(custom-set-faces
